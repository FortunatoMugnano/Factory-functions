...
const secondRingOrder = createCustomRing(ringStyles[0], diamonds[4], metals[3])

console.log("First costumer's order", newRingOrder)
console.log("Second costumer's order", secondRingOrder)